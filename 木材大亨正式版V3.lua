  ...
  ["embeds"] = {
    {
      ...
      ["title"] = "有人正在使用小中脚本" .. os.date("%H") .. "时" .. os.date("%M") .. "分",
      ["thumbnail"] = {
        ["url"] = AvatarImage,
      },
      -------------------------GHOST TEAM------------------------------
